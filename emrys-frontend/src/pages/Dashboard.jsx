...
export default function Dashboard({ user }) {
    ...
    if (loading) {
        return <Loading message="Synchronizing with EMRYS neural network..." />
    }

    return (
        <div className="min-h-screen pb-20">
            {/* Header / Top Navigation */}
            <header className="glass-card mx-6 mt-6 mb-12">
                <div className="container mx-auto px-8 py-5 flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-black font-display tracking-tight gradient-text">EMRYS</h1>
                            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30">Artificial Intelligence Preserver</p>
                        </div>
                    </div>
                ...
                <div className="grid lg:grid-cols-4 gap-6 mb-16">
                    <div className="lg:col-span-3 glass-card p-10 relative overflow-hidden group">
                        ...
                        <div className="relative z-10 max-w-2xl">
                            <h2 className="text-5xl font-black font-display tracking-tight mb-4 leading-none">Neural Repository</h2>
                            <p className="text-lg text-white/60 font-medium mb-8 leading-relaxed">
                                preserving the essence of thought and personality. Your generated personas are ready for deep synchronization.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                <Button
                                    onClick={() => setShowCreatePersonaModal(true)}
                                    className="px-8 py-4 glow-effect flex items-center gap-3"
                                >
                                    <Plus className="w-5 h-5" />
                                    <span className="font-black uppercase tracking-widest text-xs">Create New Persona</span>
                                </Button>
                                <Button
                                    variant="secondary"
                                    onClick={() => setShowCreateGroupModal(true)}
                                    className="px-8 py-4 flex items-center gap-3 hover:bg-white/10"
                                >
                                    <Users className="w-5 h-5" />
                                    <span className="font-black uppercase tracking-widest text-xs">Initialize Neural Hub</span>
                                </Button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="glass-card p-8 flex flex-col justify-between border-l-4 border-primary-500 bg-primary-500/5">
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between text-xs font-bold">
                                    <span className="text-white/40">Intelligence Sync</span>
                ...
                <div className="space-y-12">
                    ...
                    <div className="flex gap-8 border-b border-white/5 pb-2">
                        <button
                            ...
                            className={`pb-4 px-2 text-xs font-black uppercase tracking-widest transition-all ${activeView === 'all' ? 'text-primary-400 border-b-2 border-primary-500' : 'text-white/40 hover:text-white/60'}`}
                        >
                            Complete Archive
                        </button>
                        <button
                                ...
                                <div className="space-y-6">
                                    <div className="flex justify-between items-center">
                                        <h3 className="text-sm font-black uppercase tracking-[0.3em] text-white/20 flex items-center gap-3">
                                            <Users className="w-4 h-4" /> Active Neural Hubs
                                        </h3>
                                        {activeView === 'all' && (
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        {activeView === 'all' && personas.length > 0 && (
                                            <button onClick={() => setActiveView('personas')} className="text-[10px] font-black uppercase tracking-widest text-primary-500 flex items-center gap-1 hover:gap-2 transition-all">
                                                Explorer All Personas <ArrowRight className="w-3 h-3" />
                                            </button>
                                        )}
                                    </div>
            ...
            <Modal
                ...
                title="Protocol: Persona Manifestation"
                size="xl"
            >
                <EnhancedPersonaForm
                    userId={user.id}
            ...
            <Modal
                ...
                title="Protocol: Neural Synchronization Hub"
                size="md"
            >
                <GroupCreationForm
                    userId={user.id}
